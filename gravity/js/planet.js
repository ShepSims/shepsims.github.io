...
let Planet = function (system) {
	...
	this.position =
		this.system.gravityType == 1
			...
			: createVector(this.system.position.x + random(-5, 5), this.system.position.y + random(-5, 5));
...
Planet.prototype.update = function () {
	if (this.system.cursorGravity.planets == true && this.system.gravityType == 1) {
	...
	} else if (this.system.cursorGravity.planets == true && this.system.gravityType == 2) {
		this.distanceFromSystem = sqrt(
			(this.position.x - this.system.position.x) * (this.position.x - this.system.position.x) +
				(this.position.y - this.system.position.y) * (this.position.y - this.system.position.y)
		);
